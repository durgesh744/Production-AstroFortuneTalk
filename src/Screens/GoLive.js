...
import Header from '../component/Live/Header';
import Timer from '../component/Live/Timer';
import RecievedGifts from '../component/Live/RecievedGifts';
import Chats from '../component/Live/Chats';
import GiftCall from '../component/Live/GiftCall';
import Footer from '../component/Live/Footer';
import CallRequests from '../component/Live/CallRequests';
import {
  api_url,
...
import AllGifts from '../component/Live/AllGifts';
...
import NewGift from '../component/Live/NewGift';
...
export class GoLive extends Component {
  ...
  stopPublishStream = () => {
    Alert.alert('Alert', 'Are you sure end this vedio call?', [
