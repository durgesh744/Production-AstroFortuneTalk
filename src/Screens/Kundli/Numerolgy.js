...
const Numerolgy = ({navigation, route, numerologyData}) => {
  console.log(numerologyData)
  const [data] = useState(numerology_data);
  // const {numerologyData} = route.params;
  return (
...
const mapStateToProps = state =>({
  numerologyData: state.chat.numerologyData
})

const mapDispatchToProps = dispatch =>({dispatch})

export default connect(mapStateToProps, mapDispatchToProps)(Numerolgy);
